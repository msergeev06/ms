...
class Tools
{
     ...
     */
    public static function runTableClassFunction($strTable, $strFunction, $arParams = [])
    {
    ...
    public static function getFileByTableName($strTableName)
    {
        ...
        {
            $filename = $app->getSettings()->getMsRoot() . '/modules/' . $brand . '.' . $module . '/tables/' . $table
                        . '.php';
        }
    ...
    public static function HTMLToTxt($str, $strSiteUrl = "", $aDelete = [], $maxlen = 70)
    {
