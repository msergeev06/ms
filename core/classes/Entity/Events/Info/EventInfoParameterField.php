...
/**
 * Класс Ms\Core\Entity\Events\EventInfoParameterField
 * Описывает поле массива, передаваемого в качестве параметра в обработчик события
 */
class EventInfoParameterField
{
    ...
    /* * @var EventInfoParameterFieldsCollection */
    // protected $fields = null;

    public function __construct (string $name)
    {
        $this->setName($name);
        // $this->fields = new EventInfoParameterFieldsCollection();
    }
