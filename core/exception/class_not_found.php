 ...
 * Класс для исключений, возникающих при обращении к классу, файл с описанием которого не был подключен вручную
 * или расположен не по правилам расположения классов и не был добавлен в автозагрузку
 *
 * @package Ms\Core
