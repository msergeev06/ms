...
class GroupAccess
{
	...
	/**
	 * Возвращает существующие доступы для указанного модуля, типа доступа и одной или нескольких групп
	 * Полученные данные сохраняет для текущей сессии, чтобы не запрашивать вновь из базы
	 *
	 ...
	 */
	public static function addAccess ($sModuleName, $sAccessName, $iGroupID, $mAccessCode=null)
	{
