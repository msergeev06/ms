...
class SectionsTable extends TreeTable
{
     ...
     * @param int    $iParent   Родительский раздел, если 0 - размещается в корне
     * @param int    $iSort     Индекс сортировки, по-умолчанию 500
     * @param bool   $bActive   Флаг активности раздела, по-умолчанию true - активен
     *
     * @return bool|int
     */
    final public static function addSection ($sName, $iParent=0, $iSort=500, $bActive=true)
    {
        $arSection = [
            'NAME' => $sName,
            'PARENT_ID' => $iParent,
        ...
        if ($iNodeID = static::addNode($arSection))
        {
            static::sortSection($iNodeID);
        }
        return $iNodeID;
    }
    ...
    final public static function sortSection ($sectionID, $sort=null)
    {
        ...
        return static::sortNode($sectionID, 'SORT','DESC');
    }
     ...
     * @return false;
     */
    final public static function changeParentSection ($sectionID, $newParentID=null)
    {
        //OK
        if ($res = static::changeParent($sectionID, $newParentID))
        {
